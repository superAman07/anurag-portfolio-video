...
export const Hero: React.FC = () => {
  return (
    <section className="relative min-h-screen flex flex-col lg:block overflow-hidden bg-white">
      ...
      <div className="relative h-[55vh] sm:h-[60vh] lg:absolute lg:inset-0 lg:h-full z-0">
        ...
        <div className="hidden lg:block absolute inset-0 overflow-hidden">
          <video
            ...
            loop
            playsInline
            className="h-full w-full object-cover object-[center_75%]" // Shifted down from center
          />
        </div>

        {/* MOBILE & TABLET VIDEO (below lg) - Stacks at the top */}
        <div className="block lg:hidden h-full w-full overflow-hidden">
          <video
            src="/anurag-hero-bg.mp4"
            autoPlay
            muted
            loop
            playsInline
            className="h-full w-full object-cover object-[85%_95%]" // Shifted focus down to 95%
          />
        </div>
      </div>

      {/* Content Layer */}
      <div className="relative z-10 mx-auto flex flex-col justify-center max-w-7xl px-5 sm:px-6 lg:px-8 lg:min-h-screen pt-2 pb-10 sm:pt-4 sm:pb-16 lg:py-0">
