...
export const CTA: React.FC = () => {
  ...
  return (
    <section className="relative overflow-hidden bg-brand-900 py-28 lg:py-36" id="contact">
      {/* Gradient orbs */}
      ...
      <div className="relative mx-auto max-w-3xl px-6 text-center lg:px-8">
        ...
        <h2 className="font-display text-4xl font-extrabold leading-tight tracking-tight text-white sm:text-5xl lg:text-6xl">
          I'm ready to elevate <br /> your videos.
        </h2>
        ...
        <div className="mt-10 flex flex-col items-center gap-4 sm:flex-row sm:justify-center">
          ...
          <Link
            ...
            className="rounded-full border border-white/20 px-10 py-4 text-base font-semibold text-white/80 transition-all hover:border-white/40 hover:text-white"
          >
            YouTube
          </Link>
        </div>
        ...
        <p className="mt-6 text-sm text-white/30">
          Book a free 10-minute strategy call. No commitment — just a conversation about how video can transform your business.
        </p>
      </div>
            ...
            >
              ...
              <div className="p-8 sm:p-10">
                {status === 'success' ? (
                  ...
                  <>
                    <h3 className="font-display text-2xl font-bold text-brand-900">Get in Touch</h3>
